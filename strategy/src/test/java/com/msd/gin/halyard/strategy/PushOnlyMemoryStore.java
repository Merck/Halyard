...
public class PushOnlyMemoryStore extends MemoryStore implements BindingSetPipeSail {
	...
	interface BindingSetPipeNotifyingSailConnection extends BindingSetPipeSailConnection, NotifyingSailConnection {
	}
}
