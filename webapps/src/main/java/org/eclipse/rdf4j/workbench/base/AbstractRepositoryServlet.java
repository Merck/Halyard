...
import com.msd.gin.halyard.rio.HRDF;
	...
	public void setRepository(Repository repository) {
		if (repository == null) {
			...
			if (this.repository instanceof HTTPRepository) {
				// Halyard changes
				((HTTPRepository) this.repository).setPreferredRDFFormat(HRDF.FORMAT);
				((HTTPRepository) this.repository).setPreferredTupleQueryResultFormat(TupleQueryResultFormat.SPARQL_STAR);
			}
		}
	}
